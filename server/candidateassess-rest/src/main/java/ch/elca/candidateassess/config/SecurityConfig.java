...
public class SecurityConfig {
    ...
    private JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        jwtAuthenticationConverter.setJwtGrantedAuthoritiesConverter(new ElcaJwtGrantedAuthoritiesConverter());
        return jwtAuthenticationConverter;
    }

    public static class ElcaJwtGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
